 ...
 * Dashboard.jsx
 *
 * - Random data is generated on each render (useMemo for stable per mount)
 * - Layout uses Tailwind classes and reserves left margin (ml-64) so it
 *   won't overlap a typical fixed left sidebar. Adjust ml-* if needed.
 */
...
const Dashboard = () => {
  // Generate random monthly data (6 months)
  ...
  // Line chart data (daily trend for last 7 days)
  ...
  return (
    <main className="ml-64 p-6 min-h-screen bg-slate-50">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left: Bar chart (traffic by device) */}
